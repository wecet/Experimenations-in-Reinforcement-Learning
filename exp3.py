...
TAU = 1e-3              # for soft update of target parameterss
...
def show_video_of_model(agent, env_name, video_path):
    env = gym.make(env_name)
    vid = VideoRecorder(env, video_path, enabled=video_path is not None)
...
agent = Agent(state_size=8, action_size=4, seed=0)
show_video_of_model(agent, 'LunarLander-v2', 'vid.mp4')
    ...
    while True:
        ...
        for t in range(self.Training_batch):
            ...
            if done:
                ...
                print(
                    "episode: {}/{}, score: {}, average: {:.2f} {}".format(self.episode, self.EPISODES, score, average,
                                                                           SAVING))
